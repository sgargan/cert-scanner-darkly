...
// PodsInterface is an autogenerated mock type for the PodsInterface type
type PodsInterface struct {
	mock.Mock
}

// Apply provides a mock function with given fields: ctx, pod, opts
func (_m *PodsInterface) Apply(ctx context.Context, pod *v1.PodApplyConfiguration, opts metav1.ApplyOptions) (*corev1.Pod, error) {
...
func (_m *PodsInterface) ApplyStatus(ctx context.Context, pod *v1.PodApplyConfiguration, opts metav1.ApplyOptions) (*corev1.Pod, error) {
	ret := _m.Called(ctx, pod, opts)
...
func (_m *PodsInterface) Bind(ctx context.Context, binding *corev1.Binding, opts metav1.CreateOptions) error {
...
func (_m *PodsInterface) Create(ctx context.Context, pod *corev1.Pod, opts metav1.CreateOptions) (*corev1.Pod, error) {
	ret := _m.Called(ctx, pod, opts)
...
func (_m *PodsInterface) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (_m *PodsInterface) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
...
func (_m *PodsInterface) Evict(ctx context.Context, eviction *v1beta1.Eviction) error {
...
func (_m *PodsInterface) EvictV1(ctx context.Context, eviction *policyv1.Eviction) error {
	ret := _m.Called(ctx, eviction)
...
func (_m *PodsInterface) EvictV1beta1(ctx context.Context, eviction *v1beta1.Eviction) error {
	ret := _m.Called(ctx, eviction)
...
func (_m *PodsInterface) Get(ctx context.Context, name string, opts metav1.GetOptions) (*corev1.Pod, error) {
	ret := _m.Called(ctx, name, opts)
...
func (_m *PodsInterface) GetLogs(name string, opts *corev1.PodLogOptions) *rest.Request {
...
func (_m *PodsInterface) List(ctx context.Context, opts metav1.ListOptions) (*corev1.PodList, error) {
...
func (_m *PodsInterface) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (*corev1.Pod, error) {
...
func (_m *PodsInterface) ProxyGet(scheme string, name string, port string, path string, params map[string]string) rest.ResponseWrapper {
...
func (_m *PodsInterface) Update(ctx context.Context, pod *corev1.Pod, opts metav1.UpdateOptions) (*corev1.Pod, error) {
	ret := _m.Called(ctx, pod, opts)
...
func (_m *PodsInterface) UpdateEphemeralContainers(ctx context.Context, podName string, pod *corev1.Pod, opts metav1.UpdateOptions) (*corev1.Pod, error) {
...
func (_m *PodsInterface) UpdateResize(ctx context.Context, podName string, pod *corev1.Pod, opts metav1.UpdateOptions) (*corev1.Pod, error) {
	ret := _m.Called(ctx, podName, pod, opts)
...
func (_m *PodsInterface) UpdateStatus(ctx context.Context, pod *corev1.Pod, opts metav1.UpdateOptions) (*corev1.Pod, error) {
	ret := _m.Called(ctx, pod, opts)
...
func (_m *PodsInterface) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	ret := _m.Called(ctx, opts)
...
// NewPodsInterface creates a new instance of PodsInterface. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewPodsInterface(t interface {
	mock.TestingT
	Cleanup(func())
}) *PodsInterface {
	mock := &PodsInterface{}
